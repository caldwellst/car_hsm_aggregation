...
CLEANED_DATASET <- "input/car_hsm_data.csv"
...
data <- data %>%
  select(everything(), -strategie_adaptation, -strategie_survie)
...
localite_data <- localite_data %>%
  mutate(date_deplacement = ifelse(large_deplacement_population == "oui", date_deplacement, NA),
         raison_deplacement = ifelse(large_deplacement_population == "oui", raison_deplacement, NA),
         ...
         raison_inaccessible = ifelse(acces_nourriture == "oui",raison_inaccessible, NA),
         ...
         barriere_agriculture = ifelse(acces_terre == "non", barriere_agriculture, NA),
         type_betail = ifelse(possession_betail == "oui", type_betail, NA),
         epidemie_betail = ifelse(possession_betail == "oui", epidemie_betail, NA),
         raison_accouchement_maison = ifelse(lieu_accouchement == "oui", raison_accouchement_maison, NA),
